...
### 3.8 bmi1
ifeq ($(bmi1),yes)
	CXXFLAGS += -mbmi -DUSE_BMI1
endif

### 3.9 Link Time Optimization, it works since gcc 4.5 but not on mingw under Windows.
...
### 4.0 Android 5 can only run position independent executables. Note that this
