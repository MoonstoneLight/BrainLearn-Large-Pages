...
unsigned int max_threads = std::thread::hardware_concurrency();
  ...
  o["Hash"]                  << Option(1024, 1, MaxHashMB, on_hash_size);
  ...
  o["SyzygyPath"]            << Option("syzygy", on_tb_path);
  o["SyzygyProbeDepth"]      << Option(1, 1, 100);
  o["Syzygy50MoveRule"]      << Option(true);
  o["SyzygyProbeLimit"]      << Option(6, 0, 7);
  o["OwnBook"]               << Option(true); 
  o["BookFile"]              << Option("book.bin", on_book_file);
  o["BookFile 2"]            << Option("book2.bin", on_book_file2);
  o["BookFile 3"]            << Option("book3.bin", on_book_file3);
  o["BookFile 4"]            << Option("book4.bin", on_book_file4);
  o["BookFile 5"]            << Option("book5.bin", on_book_file5);
  o["BookFile 6"]            << Option("book6.bin", on_book_file6);
